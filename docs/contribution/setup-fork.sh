...
# upstream   https://github.com/ggfevans/ProxmoxVE.git (fetch)
# upstream   https://github.com/ggfevans/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/ggfevans/ProxmoxVE"
echo ""
